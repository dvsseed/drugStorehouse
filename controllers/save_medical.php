...
$sql = "INSERT INTO `medical_materials`(barcode,medical_code,medical_english,medical_chinese,specification,spec_amount,spec_unit,medical_price,medical_manufacturer,remark,agents,uniform_numbers,phone_orders,business_representatives,mobile_telephone,purchase_price,percentage_deduction,orderunit_rebates,temporary_purchase,safety_stock,selling_price,staff_price,industry_price) VALUES('$barcode','$medical_code','$medical_english','$medical_chinese','$specification','$spec_amount','$spec_unit','$medical_price','$medical_manufacturer','$remark','$agents','$uniform_numbers','$phone_orders','$business_representatives','$mobile_telephone','$purchase_price','$percentage_deduction','$orderunit_rebates','$temporary_purchase','$safety_stock','$selling_price','$staff_price','$industry_price')";
// @mysql_query($sql);
$conn->query($sql);
