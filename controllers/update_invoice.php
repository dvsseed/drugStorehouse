...
$sql = "UPDATE `invoice_info` SET purchase_date='$purchase_date',invoice_date='$invoice_date',drug_code='$drug_code',stock_code='$stock_code',drug_english='$drug_english',drug_chinese='$drug_chinese',drugspec_amount='$drugspec_amount',drugspec_unit='$drugspec_unit',drugprices_reference='$drugprices_reference',drug_manufacturer='$drug_manufacturer',agents='$agents',quantity='$quantity',grant_amount='$grant_amount',total='$total',purchase='$purchase',invoice_number='$invoice_number',invoice_amount='$invoice_amount',discount_amount='$discount_amount',business_tax='$business_tax',discount_afteramount='$discount_afteramount',unit_price='$unit_price',price_difference='$price_difference',purchase_price='$purchase_price',percentage_deduction='$percentage_deduction',expiration_date='$expiration_date',lot_number='$lot_number',payment_date='$payment_date',paid_afterdeduction='$paid_afterdeduction',before3months_consumption='$before3months_consumption',business_representatives='$business_representatives',mobile_telephone='$mobile_telephone',phone_orders='$phone_orders',storage_location='$storage_location',return_1F='$return_1F' WHERE id=$id";
// @mysql_query($sql);
$conn->query($sql);
