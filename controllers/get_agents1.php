...
$sort = isset($_POST['sort']) ? $_POST['sort'] : 'uniform_numbers';
$order = isset($_POST['order']) ? $_POST['order'] : 'asc';

if (isset($_POST['dddasearch_field'])) {
    //有 search
    // $searchwhat = isset($_POST['dddasearch_what']) ? mysql_real_escape_string($_POST['dddasearch_what']) : '';
    $searchwhat = isset($_POST['dddasearch_what']) ? mysqli_real_escape_string($conn, $_POST['dddasearch_what']) : '';
    $where = " WHERE " . $_POST['dddasearch_field'] . " LIKE '%" . $searchwhat . "%'";
} else { $where = "";} //無 search
