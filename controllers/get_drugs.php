...
if (isset($_POST['search_field'])) {
    //有 search
    // $searchwhat = isset($_POST['search_what']) ? mysql_real_escape_string($_POST['search_what']) : '';
    $searchwhat = isset($_POST['search_what']) ? mysqli_real_escape_string($conn, $_POST['search_what']) : '';
    $where = " WHERE " . $_POST['search_field'] . " LIKE '%" . $searchwhat . "%'";
} else { $where = "";} //無 search
